...
<!-- component -->
<div class="flex items-center justify-center h-screen overflow-hidden bg-yellow-400">
  <div class="w-10/12 bg-white lg:w-5/12 md:6/12 shadow-3xl">
    ...
    @csrf
      ...
      <div class="flex items-center mb-6 text-lg md:mb-8">
        ...
        <input type="password" id="password" name="password" class="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" placeholder="Password" />
      </div>
